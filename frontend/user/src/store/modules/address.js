...
const actions =  {
  ...
  async getUserSenderAddress({ commit }) {
    commit("setLoader", true, { root: true });
    await axios.get(process.env.VUE_APP_API_URL + "address/alladdresses")
    .then(response => {
