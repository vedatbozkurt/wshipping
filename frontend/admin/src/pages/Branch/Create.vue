      ...
      <div class="container-fluid">
            ...
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><router-link to="/">{{ $t('home') }}</router-link>
                <li class="breadcrumb-item"><router-link to="/branch">{{ $t('branch.branches') }}</router-link>
                  <li class="breadcrumb-item active">{{ $t('branch.createBranch') }}</li>
                </ol>
              </div>
            </div>
          </div><!-- /.container-fluid -->
        ...
        <section class="content">
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">{{ $t('branch.newBranchForm') }}</h3>
        ...
        <form>
          ...
          <div class="card-footer">
            <button type="button" @click="addBranch()" class="btn btn-info">{{ $t('save') }}</button>
  ...
  methods: {
    ...
    addBranch: function() {
      this.createBranch(this.branch).then(() => {
        this.myToast('success',this.$t('branch.createdBranch'));
