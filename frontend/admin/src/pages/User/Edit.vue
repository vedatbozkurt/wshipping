            ...
            <form>
              ...
              <div class="card-body">
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <img width="150" :src="getProfilePhoto()" alt="User Image" v-bind:class="{ 'is-invalid':errors.image }">
    ...
    <script>
     ...
     export default {
      ...
      methods: {
        ...
        getProfilePhoto(){
          if (this.user.image) {
            return process.env.VUE_APP_URL+"images/user/" + this.user.previous_image;
          }else{
            return process.env.LARAVEL_APP_URL+"images/user/"+ this.user.image;
          }
        },
      }
    }
