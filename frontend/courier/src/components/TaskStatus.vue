...
.kuryeatamasiyapildi { background-color:#99eaff; }
.kuryekabuledilmebekleniyor { background-color:#c6e2ff; }
.kuryekabuletti { background-color:#97e010 ; }
.kuryeyolda { background-color:#7fffbf ; }
