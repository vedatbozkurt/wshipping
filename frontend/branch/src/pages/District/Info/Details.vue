    ...
    <form>
      <div class="card-body">
        <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <multiselect v-model="district.city" :deselect-label="$t('select.cantRemove')" track-by="name" label="name" :placeholder="$t('select.selectCity')" :options="cities" :searchable="true" :allow-empty="false" disabled>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" v-model="district.name" v-bind:class="{ 'is-invalid':errors.name }"  disabled>
